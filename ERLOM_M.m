...
% 读取各个参数
% A = kBT/h   B = kBT   f = f   C1 = λ1 C2 = λ2 C3 = λ3 C4 = λ4
...
fun3 = @(a) A*exp(((G2-(a - 0.0592*pH)+ C2).^2)./(-4*B*C2))+...
            A*exp(((G2-(a - 0.0592*(pH-14))+ C2).^2)./(-4*B*C2))*10^(pH-14);
fun4 = @(a) A*exp(((-G2+(a - 0.0592*pH)+ C2).^2)./(-4*B*C2))*10^(-pH)+...
            A*exp(((-G2+(a - 0.0592*(pH-14))+ C2).^2)./(-4*B*C2));
fun5 = @(a) A*exp(((G3-(a - 0.0592*pH)+ C3).^2)./(-4*B*C3))+...
            A*exp(((G3-(a - 0.0592*(pH-14))+ C3).^2)./(-4*B*C3))*10^(pH-14);
fun6 = @(a) A*exp(((-G3+(a - 0.0592*pH)+ C3).^2)./(-4*B*C3))*10^(-pH)+...
            A*exp(((-G3+(a - 0.0592*(pH-14))+ C3).^2)./(-4*B*C3));
fun7 = @(a) A*exp(((G4-(a - 0.0592*pH)+ C4).^2)./(-4*B*C4))+...
            A*exp(((G4-(a - 0.0592*(pH-14))+ C4).^2)./(-4*B*C4))*10^(pH-14);
fun8 = @(a) A*exp(((-G4+(a - 0.0592*pH)+ C4).^2)./(-4*B*C4))*10^(-pH)+...
...
fun3 = @(b) A*exp(((G2-(overpotential - 0.0592*b)+ C2).^2)./(-4*B*C2))+...
            A*exp(((G2-(overpotential - 0.0592*(b-14))+ C2).^2)./(-4*B*C2))*10^(b-14);
fun4 = @(b) A*exp(((-G2+(overpotential - 0.0592*b)+ C2).^2)./(-4*B*C2))*10^(-b)+...
            A*exp(((-G2+(overpotential - 0.0592*(b-14))+ C2).^2)./(-4*B*C2));
fun5 = @(b) A*exp(((G3-(overpotential - 0.0592*b)+ C3).^2)./(-4*B*C3))+...
            A*exp(((G3-(overpotential - 0.0592*(b-14))+ C3).^2)./(-4*B*C3))*10^(b-14);
fun6 = @(b) A*exp(((-G3+(overpotential - 0.0592*b)+ C3).^2)./(-4*B*C3))*10^(-b)+...
            A*exp(((-G3+(overpotential - 0.0592*(b-14))+ C3).^2)./(-4*B*C3));
fun7 = @(b) A*exp(((G4-(overpotential - 0.0592*b)+ C4).^2)./(-4*B*C4))+...
            A*exp(((G4-(overpotential - 0.0592*(b-14))+ C4).^2)./(-4*B*C4))*10^(b-14);
fun8 = @(b) A*exp(((-G4+(overpotential - 0.0592*b)+ C4).^2)./(-4*B*C4))*10^(-b)+...

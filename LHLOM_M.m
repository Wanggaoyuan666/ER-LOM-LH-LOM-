...
fun1 = @(a) A*exp(((G1-(a - 0.0592*pH)+ C1).^2)./(-4*B*C1))+...
            A*exp(((G1-(a - 0.0592*(pH-14))+ C1).^2)./(-4*B*C1))*10^(pH-14);
fun2 = @(a) A*exp(((-G1+(a - 0.0592*pH)+ C1).^2)./(-4*B*C1))*10^(-pH)+...
            A*exp(((-G1+(a - 0.0592*(pH-14))+ C1).^2)./(-4*B*C1));
fun3 = @(a) A*exp(((G2_1-(a - 0.0592*pH)+ C2_1).^2)./(-4*B*C2_1))+...
            A*exp(((G2_1-(a - 0.0592*(pH-14))+ C2_1).^2)./(-4*B*C2_1))*10^(pH-14);
fun4 = @(a) A*exp(((-G2_1+(a - 0.0592*pH)+ C2_1).^2)./(-4*B*C2_1))*10^(-pH)+...
            A*exp(((-G2_1+(a - 0.0592*(pH-14))+ C2_1).^2)./(-4*B*C2_1));
fun5 = @(a) A*exp(((G2_2-(a - 0.0592*pH)+ C2_2).^2)./(-4*B*C2_2))+...
            A*exp(((G2_2-(a - 0.0592*(pH-14))+ C2_2).^2)./(-4*B*C2_2))*10^(pH-14);
fun6 = @(a) A*exp(((-G2_2+(a - 0.0592*pH)+ C2_2).^2)./(-4*B*C2_2))*10^(-pH)+...
            A*exp(((-G2_2+(a - 0.0592*(pH-14))+ C2_2).^2)./(-4*B*C2_2));
fun7 = @(a) A*exp(((G3_1-(a - 0.0592*pH)+ C3_1).^2)./(-4*B*C3_1))+...
            A*exp(((G3_1-(a - 0.0592*(pH-14))+ C3_1).^2)./(-4*B*C3_1))*10^(pH-14);
fun8 = @(a) A*exp(((-G3_1+(a - 0.0592*pH)+ C3_1).^2)./(-4*B*C3_1))*10^(-pH)+...
            A*exp(((-G3_1+(a - 0.0592*(pH-14))+ C3_1).^2)./(-4*B*C3_1));
fun9 = @(a) A*exp(((G3_2-(a - 0.0592*pH)+ C3_2).^2)./(-4*B*C3_2))+...
            A*exp(((G3_2-(a - 0.0592*(pH-14))+ C3_2).^2)./(-4*B*C3_2))*10^(pH-14);
fun10 = @(a) A*exp(((-G3_2+(a - 0.0592*pH)+ C3_2).^2)./(-4*B*C3_2))*10^(-pH)+...
             A*exp(((-G3_2+(a - 0.0592*(pH-14))+ C3_2).^2)./(-4*B*C3_2));
fun11 = @(a) A*exp(((G4-(a - 0.0592*pH)+ C4).^2)./(-4*B*C4))+...
             A*exp(((G4-(a - 0.0592*(pH-14))+ C4).^2)./(-4*B*C4))*10^(pH-14);
fun12 = @(a) A*exp(((-G4+(a - 0.0592*pH)+ C4).^2)./(-4*B*C4))*10^(-pH)+...
             A*exp(((-G4+(a - 0.0592*(pH-14))+ C4).^2)./(-4*B*C4));
...
% 定义被积函数，a为过电势 
fun1 = @(b) A*exp(((G1-(overpotential - 0.0592*b)+ C1).^2)./(-4*B*C1))+...
            A*exp(((G1-(overpotential - 0.0592*(b-14))+ C1).^2)./(-4*B*C1))*10^(b-14);
fun2 = @(b) A*exp(((-G1+(overpotential - 0.0592*b)+ C1).^2)./(-4*B*C1))*10^(-b)+...
            A*exp(((-G1+(overpotential - 0.0592*(b-14))+ C1).^2)./(-4*B*C1));
fun3 = @(b) A*exp(((G2_1-(overpotential - 0.0592*b)+ C2_1).^2)./(-4*B*C2_1))+...
            A*exp(((G2_1-(overpotential - 0.0592*(b-14))+ C2_1).^2)./(-4*B*C2_1))*10^(b-14);
fun4 = @(b) A*exp(((-G2_1+(overpotential - 0.0592*b)+ C2_1).^2)./(-4*B*C2_1))*10^(-b)+...
            A*exp(((-G2_1+(overpotential - 0.0592*(b-14))+ C2_1).^2)./(-4*B*C2_1));
fun5 = @(b) A*exp(((G2_2-(overpotential - 0.0592*b)+ C2_2).^2)./(-4*B*C2_2))+...
            A*exp(((G2_2-(overpotential - 0.0592*(b-14))+ C2_2).^2)./(-4*B*C2_2))*10^(b-14);
fun6 = @(b) A*exp(((-G2_2+(overpotential - 0.0592*b)+ C2_2).^2)./(-4*B*C2_2))*10^(-b)+...
            A*exp(((-G2_2+(overpotential - 0.0592*(b-14))+ C2_2).^2)./(-4*B*C2_2));
fun7 = @(b) A*exp(((G3_1-(overpotential - 0.0592*b)+ C3_1).^2)./(-4*B*C3_1))+...
            A*exp(((G3_1-(overpotential - 0.0592*(b-14))+ C3_1).^2)./(-4*B*C3_1))*10^(b-14);
fun8 = @(b) A*exp(((-G3_1+(overpotential - 0.0592*b)+ C3_1).^2)./(-4*B*C3_1))*10^(-b)+...
            A*exp(((-G3_1+(overpotential - 0.0592*(b-14))+ C3_1).^2)./(-4*B*C3_1));
fun9 = @(b) A*exp(((G3_2-(overpotential - 0.0592*b)+ C3_2).^2)./(-4*B*C3_2))+...
            A*exp(((G3_2-(overpotential - 0.0592*(b-14))+ C3_2).^2)./(-4*B*C3_2))*10^(b-14); 
fun10 = @(b) A*exp(((-G3_2+(overpotential - 0.0592*b)+ C3_2).^2)./(-4*B*C3_2))*10^(-b)+...
            A*exp(((-G3_2+(overpotential - 0.0592*(b-14))+ C3_2).^2)./(-4*B*C3_2));
fun11 = @(b) A*exp(((G4-(overpotential - 0.0592*b)+ C4).^2)./(-4*B*C4))+...
            A*exp(((G4-(overpotential - 0.0592*(b-14))+ C4).^2)./(-4*B*C4))*10^(b-14);
fun12 = @(b) A*exp(((-G4+(overpotential - 0.0592*b)+ C4).^2)./(-4*B*C4))*10^(-b)+...
            A*exp(((-G4+(overpotential - 0.0592*(b-14))+ C4).^2)./(-4*B*C4));
fun13 = @(G5) A*exp((-1/B).*(Ea0+gama*G5));
fun14 = @(G5) A*exp((-1/B).*(Ea0-gama*G5));

...
% 溶剂重组能C C1 = λ1，以此类推
C1 = dataOP(16,2);C2_1 = dataOP(17,2);C2_2 = dataOP(18,2);C3_1 = dataOP(19,2);
C3_2 = dataOP(20,2);C4 = dataOP(21,2);

% 积分上下限
shang = Inf; xia = -Inf;
disp('第1节运行完毕，已获取Marcus-Gerischer参数！')
...
fun3 = @(x, a) exp(((G2_1-(a - 0.0592*pH)+x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(-x./B)))+...
               exp(((G2_1-(a - 0.0592*(pH-14))+x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(-x./B)))*10^(pH-14); 
fun4 = @(x, a) exp(((-G2_1+(a - 0.0592*pH)-x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(x./B)))*10^(-pH)+...
               exp(((-G2_1+(a - 0.0592*(pH-14))-x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(x./B)));
fun5 = @(x, a) exp(((G2_2-(a - 0.0592*pH)+x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(-x./B)))+...
               exp(((G2_2-(a - 0.0592*(pH-14))+x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(-x./B)))*10^(pH-14); 
fun6 = @(x, a) exp(((-G2_2+(a - 0.0592*pH)-x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(x./B)))*10^(-pH)+...
               exp(((-G2_2+(a - 0.0592*(pH-14))-x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(x./B)));
fun7 = @(x, a)exp(((G3_1-(a - 0.0592*pH)+x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(-x./B)))+...
               exp(((G3_1-(a - 0.0592*(pH-14))+x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(-x./B)))*10^(pH-14); 
fun8 = @(x, a) exp(((-G3_1+(a - 0.0592*pH)-x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(x./B)))*10^(-pH)+...
               exp(((-G3_1+(a - 0.0592*(pH-14))-x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(x./B)));
fun9 = @(x, a) exp(((G3_2-(a - 0.0592*pH)+x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(-x./B)))+...
               exp(((G3_2-(a - 0.0592*(pH-14))+x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(-x./B)))*10^(pH-14); 
fun10 = @(x, a) exp(((-G3_2+(a - 0.0592*pH)-x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(x./B)))*10^(-pH)+...
               exp(((-G3_2+(a - 0.0592*(pH-14))-x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(x./B)));
fun11 = @(x, a)exp(((G4-(a - 0.0592*pH)+x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(-x./B)))+...
               exp(((G4-(a - 0.0592*(pH-14))+x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(-x./B)))*10^(pH-14); 
fun12 = @(x, a) exp(((-G4+(a - 0.0592*pH)-x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(x./B)))*10^(-pH)+...
...
for i = 1:length(parameterColumn) 
    ...
    resultColumn9(i) = A*integral(@(x) fun9(x, a), xia,shang); 
    resultColumn10(i) = A*integral(@(x) fun10(x, a), xia,shang);
    resultColumn11(i) = A*integral(@(x) fun11(x, a), xia,shang); 
    resultColumn12(i) = A*integral(@(x) fun12(x, a), xia,shang);
...
fun3 = @(x, b) exp(((G2_1-(overpotential - 0.0592*b)+x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(-x./B)))+...
               exp(((G2_1-(overpotential - 0.0592*(b-14))+x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(-x./B)))*10^(b-14); 
fun4 = @(x, b) exp(((-G2_1+(overpotential - 0.0592*b)-x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(x./B)))*10^(-b)+...
               exp(((-G2_1+(overpotential - 0.0592*(b-14))-x + C2_1).^2)./(-4*B*C2_1)).*(1./(1 + exp(x./B)));
fun5 = @(x, b) exp(((G2_2-(overpotential - 0.0592*b)+x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(-x./B)))+...
               exp(((G2_2-(overpotential - 0.0592*(b-14))+x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(-x./B)))*10^(b-14); 
fun6 = @(x, b) exp(((-G2_2+(overpotential - 0.0592*b)-x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(x./B)))*10^(-b)+...
               exp(((-G2_2+(overpotential - 0.0592*(b-14))-x + C2_2).^2)./(-4*B*C2_2)).*(1./(1 + exp(x./B)));
fun7 = @(x, b) exp(((G3_1-(overpotential - 0.0592*b)+x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(-x./B)))+...
               exp(((G3_1-(overpotential - 0.0592*(b-14))+x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(-x./B)))*10^(b-14); 
fun8 = @(x, b) exp(((-G3_1+(overpotential - 0.0592*b)-x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(x./B)))*10^(-b)+...
               exp(((-G3_1+(overpotential - 0.0592*(b-14))-x + C3_1).^2)./(-4*B*C3_1)).*(1./(1 + exp(x./B)));
fun9 = @(x, b) exp(((G3_2-(overpotential - 0.0592*b)+x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(-x./B)))+...
               exp(((G3_2-(overpotential - 0.0592*(b-14))+x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(-x./B)))*10^(b-14); 
fun10 = @(x, b) exp(((-G3_2+(overpotential - 0.0592*b)-x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(x./B)))*10^(-b)+...
               exp(((-G3_2+(overpotential - 0.0592*(b-14))-x + C3_2).^2)./(-4*B*C3_2)).*(1./(1 + exp(x./B)));
fun11 = @(x, b) exp(((G4-(overpotential - 0.0592*b)+x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(-x./B)))+...
               exp(((G4-(overpotential - 0.0592*(b-14))+x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(-x./B)))*10^(b-14); 
fun12 = @(x, b) exp(((-G4+(overpotential - 0.0592*b)-x + C4).^2)./(-4*B*C4)).*(1./(1 + exp(x./B)))*10^(-b)+...
...
for i = 1:length(parameterColumn) 
    ...
    resultColumn9(i) = A*integral(@(x) fun9(x, b), xia,shang); 
    resultColumn10(i) = A*integral(@(x) fun10(x, b), xia,shang);
    resultColumn11(i) = A*integral(@(x) fun11(x, b), xia,shang); 
    resultColumn12(i) = A*integral(@(x) fun12(x, b), xia,shang);
    resultColumn13(i) = fun13(G5);
    resultColumn14(i) = fun14(G5);
end 
